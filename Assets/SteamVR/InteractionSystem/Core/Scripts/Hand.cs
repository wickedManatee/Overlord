...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		private TextMesh debugText2;
		public string currentDebugText2 = "";
		...
		private void UpdateDebugText()
		{
			if ( showDebugText )
			{
				...
				if ( debugText2 == null )
				{
					debugText2 = new GameObject( "_debug_text2" ).AddComponent<TextMesh>();
					debugText2.fontSize = 120;
					debugText2.characterSize = 0.01f;
					debugText2.transform.parent = transform;

					debugText2.transform.localRotation = Quaternion.Euler( 90.0f, 0.0f, 0.0f );
				}

				if ( GuessCurrentHandType() == HandType.Right )
				{
					debugText2.transform.localPosition = new Vector3( -0.25f, 0.0f, 0.0f );
					debugText2.alignment = TextAlignment.Right;
					debugText2.anchor = TextAnchor.UpperRight;
				}
				else
				{
					debugText2.transform.localPosition = new Vector3( 0.25f, 0.0f, 0.0f );
					debugText2.alignment = TextAlignment.Left;
					debugText2.anchor = TextAnchor.UpperLeft;
				}

				debugText2.text = currentDebugText2;
			}
			else
			{
				if ( debugText != null )
		...
		//-------------------------------------------------
		// Was the standard interaction button just pressed? In VR, this is a grip press. In 2D fallback, this is a mouse left-click.
		//-------------------------------------------------
		public bool GetStandardGripButtonDown()
		{
			if ( noSteamVRFallbackCamera )
			{
		...
		//-------------------------------------------------
		// Was the standard interaction button just released? In VR, this is a grip press. In 2D fallback, this is a mouse left-click.
		//-------------------------------------------------
		public bool GetStandardGripButtonUp()
		{
			if ( noSteamVRFallbackCamera )
			{
		...
		//-------------------------------------------------
		// Is the standard interaction button being pressed? In VR, this is a grip press. In 2D fallback, this is a mouse left-click.
		//-------------------------------------------------
		public bool GetStandardGripButton()
		{
			if ( noSteamVRFallbackCamera )
			{
		...
		//-------------------------------------------------
		public bool GetStandardTriggerButtonDown()
		{
			if ( noSteamVRFallbackCamera )
			{
		...
		//-------------------------------------------------
		public bool GetStandardTriggerButtonUp()
		{
			if ( noSteamVRFallbackCamera )
			{
		...
		//-------------------------------------------------
		public bool GetStandardTriggerButton()
		{
			if ( noSteamVRFallbackCamera )
			{
		...
		//-------------------------------------------------
		// Is the standard A button being pressed? In VR, this is a A press. In 2D fallback, this is a 'e' press.
		//-------------------------------------------------
		public bool GetStandardAButton()
		{
			if ( noSteamVRFallbackCamera )
			{
			...
			else if ( controller != null )
			{
				...
				return controller.GetPress(EVRButtonId.k_EButton_A);
			}
		...
		//-------------------------------------------------
		// Was the standard A button just pressed? In VR, this is a A press. In 2D fallback, this is a E.
		//-------------------------------------------------
		public bool GetStandardAButtonDown()
		{
			if ( noSteamVRFallbackCamera )
			{
				return Input.GetButtonDown("e");
			}
			else if ( controller != null )
			{
				return controller.GetPressDown(EVRButtonId.k_EButton_A);
			}
		...
		//-------------------------------------------------
		// Was the standard A button just released? In VR, this is a A press. In 2D fallback, this is a E.
		//-------------------------------------------------
		public bool GetStandardAButtonUp()
		{
			if ( noSteamVRFallbackCamera )
			{
				return Input.GetButtonUp("e");
			}
			else if ( controller != null )
			{
				return controller.GetPressUp(EVRButtonId.k_EButton_A);
			}
		...
		private void InitController( int index )
		{
			if ( controller == null )
			{
                ...
                controllerObject.transform.localPosition = controllerPrefab.transform.localPosition;
