...
namespace Valve.VR.InteractionSystem
{
	...
	public class CircularDrive : MonoBehaviour
	{
		...
		private void OnHandHoverEnd( Hand hand )
		{
			...
			if ( driving && hand.GetStandardGripButton() )
			{
		...
		private void HandHoverUpdate( Hand hand )
		{
			...
			else if ( hand.GetStandardGripButtonUp() )
			{
			...
			else if ( driving && hand.GetStandardGripButton() && hand.hoveringInteractable == GetComponent<Interactable>() )
			{
				ComputeAngle( hand );
				UpdateAll();
			}
